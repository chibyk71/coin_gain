...
<div class="page_title section-padding">
    ...
    <div class="bug_bunty">
            ...
            <div class="row">
                <div class="col-xl-9 col-lg-9">
                    ...
                    <div class="target_overview">
                        ...
                        <div class="tag_list">
                            <a href="bug-bunty.html#">CS MONEY</a>
                            <a href="bug-bunty.html#">support.cs.money</a>
                            <a href="bug-bunty.html#">3d.cs.money</a>
                        </div>
                    </div>
     ...
     <div class="ani-13">
        <img class="a1" src="images/svg/line3.svg" alt="">
        <img class="a2" src="images/svg/tricircle1.svg" alt="">
        <img class="a3" src="images/svg/tricircle2.svg" alt="">
        <img class="a4" src="images/svg/tricircle3.svg" alt="">
    </div>
    <div class="ani-16">
        <img class="a1" src="images/svg/ani-16.png" alt="">
    </div>