            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="page_title-content">
                        <a href="shop.html">
                            <p><span><i class="fa fa-angle-left"></i></span> Back to Shop</p>
                        </a>
                        <h3>Withdraw to Crypto Currencies</h3>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-footer">
                                <div class="website">
                                    ...
                                    <a href="shop-crypto-withdraw.html#">
                                        <p>Website</p>
                                    </a>
                                </div>
                                <div class="help">
                ...
                <div class="col-xl-9">
                    <div class="shop_card_content">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="shop-crypto-withdraw.html#">
