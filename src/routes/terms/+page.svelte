...
<div class="page_title section-padding">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="page_title-content">
                        <p>Last updated: April 27, 20223</p>
    ...
    <div class="terms_condition">
                ...
                <div class="col-xl-12">
                    <div class="terms_condition-content">
                        <div class="terms_condition-text">
                            ...
                            <p>By using CoinGain.com you agree to and are bound by these Terms and Conditions in
                                their
                                ...
                                are
                                prohibited from using CoinGain.com.</p>
                        </div>
                        ...
                        <div class="terms_condition-text">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <p>You must not use CoinGain.com in any way that can cause damage to
                                        CoinGain.com or in any way which is unlawful, illegal, fraudulent or
                                        harmful,
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <p>Account balance may not be transferred, exchanged, sold, or otherwise change
                                        ownership under any circumstances, except by CoinGain.com</p>
                                </li>
                                <li>
                                    <i class="fa fa-circle"></i>
                        ...
                        <div class="terms_condition-text">
                            <h3>Indemnity : </h3>
                            <p>You hereby indemnify CoinGain.com and undertake to keep CoinGain.com indemnified
                                against any losses, damages, costs, liabilities, and/or expenses (including without
                                limitation legal expenses) and any amounts paid by CoinGain.com to a third party
                                in
                                settlement of a claim or dispute on the advice of CoinGain.com’s legal advisers)
                                incurred or suffered by CoinGain.com arising out of any breach by you of any
                                provision
                        ...
                        <div class="terms_condition-text">
                            <h3>Modifications: </h3>
                            <p>CoinGain.com may revise these terms of use for its website at any time without
                                notice.
                        ...
                        <div class="terms_condition-text">
                            ...
                            <ul>
                                <li>
                                    <i class="fa fa-circle"></i>
                                    <p>CoinGain.com reserves the rights under these terms and conditions to take
                                        action if you breach these terms and conditions in any way. </p>
                                </li>
                                <li>
                                    <i class="fa fa-circle"></i>
                                    <p>CoinGain.com may take such action as seems appropriate to deal with the
                                        breach,
                                        including suspending your access to the website, suspending your earnings
                                        made
                                        trough CoinGain.com,prohibiting you from accessing the website, or
                                        bringing
        ...
        <div class="ani-9">
            <img src="images/svg/brown-polygon.svg" alt="">
        </div>
        <div class="ani-10">
            <img src="images/svg/straight-line.svg" alt="">
        </div>
        <div class="ani-11">
            <img src="images/svg/circleline.svg" alt="">
        </div>
